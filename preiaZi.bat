...
echo c:\Python27\python.exe main.py --generateMonetare=1 --generateWorkOrders=1 %args%
c:\Python27\python.exe main.py --generateMonetare=1 --generateWorkOrders=1 %args%
